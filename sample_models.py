...
from keras.layers import (BatchNormalization, Conv1D, Dense, Input, 
    TimeDistributed, Activation, Bidirectional, SimpleRNN, GRU, LSTM, 
                         Dropout, Concatenate, Conv2D, MaxPooling1D)
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for num in range(recur_layers):
        ...
        simp_rnn = GRU(units, activation='relu', 
                       ...
                       implementation=2, name=rnn_name)(rnn_input)
...
def final_model(input_dim, filters=50, kernel_size=5, units=200, output_dim=29,
                recur_layers=3, activation='relu', dropout_rate=0.2):
    """ 
    ...
    for num in range(recur_layers):
        ...
        simp_rnn = LSTM(units, activation='tanh', return_sequences=True,
                        implementation=2, name=rnn_name)
